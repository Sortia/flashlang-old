    ...
    <div class="card-body">
        <div class="col-sm-12 my-1 mb-3">
            ...
            <div class="input-group">
                ...
                <input autocomplete="off" name="front" type="text" class="form-control" id="front_text" placeholder="Front">
            </div>
        </div>
        ...
        <div class="col-sm-12 my-1 mb-3">
            ...
            <div class="input-group">
                ...
                <input autocomplete="off" name="back" type="text" class="form-control" id="back_text" placeholder="Back">
            </div>
        </div>
        <div class="col-lg-12">
